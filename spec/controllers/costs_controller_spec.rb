  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved cost as @cost" do
        ...
        post :create, {:cost => { "name" => "invalid value" }}, valid_session
        assigns(:cost).should be_a_new(Cost)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested cost" do
        ...
        Cost.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => cost.to_param, :cost => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the cost as @cost" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Cost.any_instance.stub(:save).and_return(false)
        put :update, {:id => cost.to_param, :cost => { "name" => "invalid value" }}, valid_session
        assigns(:cost).should eq(cost)
      end
